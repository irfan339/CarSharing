GRANT ALL PRIVILEGES on carshare_database.*
...
user_id INT(4), 
departure CHAR(30),
departureLongitude FLOAT(30), 
departureLatitude FLOAT(30), 
destination CHAR(30),
destinationLongitude FLOAT(30), 
destinationLatitude FLOAT(30),
price CHAR(10), 
